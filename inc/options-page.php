	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<!-- <tr valign="top">
					<th scope="row"><?php _e('Navigation Link Color', 'entheme'); ?></th>
					<td>
						<label for="use_page_background_color"><input type="checkbox" name="use_page_background_color" id="use_page_background_color" value="1" <?php checked('1', get_option('use_page_background_color')); ?>> <?php _e('Use page background color', 'entheme'); ?></label>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"><?php _e('Navigation Hover Color', 'entheme'); ?></th>
					<td><input type="text" name="navigation_hover_background_color" value="<?php echo get_option('navigation_hover_background_color'); ?>" class="entheme-color-picker" data-default-color="#ffffff" /></td>
				</tr> -->
			</table>
